...
export class Snowball {
    ...
    private _parent?: Snowball

    public children: { [key: string]: Snowball } = {}
    public data: { [key: string]: any } = {}

    getName(child: Snowball) {
...
export class GlacierBuilder {

    public extraFiles: Array<File> = []

    constructor(
        public root: Snowball,
...
export function meltdown(_options?: any) {

    let options: MeltdownOptions = Object.assign({
        staticPath: '__ext'
    }, _options)
